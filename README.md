...
### ➡️ for prerequisites, see this guide for detailed steps [Data Engineering Pipelines with Snowpark Python Prerequisites](https://drive.google.com/file/d/1ZRbyZs-ttOg8DAyPqCPvNpAcTJTEJq_g/view).
